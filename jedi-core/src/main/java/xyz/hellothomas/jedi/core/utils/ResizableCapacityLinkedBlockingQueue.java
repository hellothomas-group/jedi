...
public class ResizableCapacityLinkedBlockingQueue<E> extends AbstractQueue<E>
    ...
    private static final long serialVersionUID = -8167161978183433879L;
...
//     }
    ...
    /**
     * Creates a {@code VLenLinkedBlockingQueue} with a capacity of
    ...
    /**
     * Creates a {@code VLenLinkedBlockingQueue} with the given (fixed) capacity.
     *
     ...
     * @return
     */
    public boolean resizeCapacity(int newCapacity) {
