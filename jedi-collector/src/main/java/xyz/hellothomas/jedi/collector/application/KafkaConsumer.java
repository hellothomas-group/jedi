...
public class KafkaConsumer {
     ...
     * @param records
     */
    @KafkaListener(topics = "${collector.executor-ticker-topic}")
     ...
     * @param records
     */
    @KafkaListener(topics = "${collector.executor-task-topic}")
     ...
     * @param records
     */
    @KafkaListener(topics = "${collector.executor-shutdown-topic}")
     ...
     * @param records
     */
    @KafkaListener(topics = "${collector.custom-notification-topic}")
