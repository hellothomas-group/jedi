...
public class ExecutorTaskController {
    ...
    public PageResult<ExecutorTaskDetailResponse> find(@PathVariable("namespaceName") String namespaceName,
    ...
    private PageResult<ExecutorTaskDetailResponse> transform2PageResult(PageResult<ExecutorTaskMessage> taskMessagePageResult) {
        List<ExecutorTaskDetailResponse> executorTaskDetailRespons = LocalBeanUtils.batchTransform(ExecutorTaskDetailResponse.class,
