CREATE TABLE JEDI_TASK_EXECUTION (
  ...
  IS_RECOVERABLE NUMBER(1,0) DEFAULT 0 NOT NULL,
  IS_RECOVERED NUMBER(1,0) DEFAULT 0 NOT NULL,
  HOST VARCHAR2(15 char) NOT NULL,
  MACHINE_ID VARCHAR2(15 char) NOT NULL,
  TRACE_ID VARCHAR2(32 char),
  IS_BY_RETRYER NUMBER(1,0) DEFAULT 0 NOT NULL,
  PREVIOUS_ID VARCHAR2(36 char),
  PARENT_ID VARCHAR2(36 char),
  IS_EXECUTED_BY_PARENT_TASK_THREAD NUMBER(1,0) DEFAULT 0 NOT NULL,
...
COMMENT ON COLUMN JEDI_TASK_EXECUTION.IS_RECOVERABLE IS '1:recoverable, 0:not recoverable';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.IS_RECOVERED IS '1:recovered, 0:normal';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.HOST IS 'host';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.MACHINE_ID IS 'machineId';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.TRACE_ID IS 'traceId';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.IS_BY_RETRYER IS '1:byRetryer, 0:normal';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.PREVIOUS_ID IS 'previousId';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.PARENT_ID IS 'parentId';
COMMENT ON COLUMN JEDI_TASK_EXECUTION.IS_EXECUTED_BY_PARENT_TASK_THREAD IS '1:true, 0:false';
...
CREATE INDEX JEDI_TASK_EXECUTION_IDX_1 ON JEDI_TASK_EXECUTION(STATUS, MACHINE_ID, IS_RECOVERABLE, CREATE_TIME);
